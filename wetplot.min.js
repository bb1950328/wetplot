...
var WetplotDataController=function(){this.data=new WetplotData;this.data_providers=[]};WetplotDataController.prototype.addDataProvider=function(a){this.data_providers.push(a)};
...
Wetplot.prototype._addDataToDb=function(a,c){this._openDb(function(b){function d(a){console.debug("Add "+JSON.stringify(a));e.add(a)}b=b.transaction([a],"readwrite");var e=b.objectStore(a);c.forEachObject(function(a){var b=e.get(a.Time);b.onsuccess=function(c){c=b.result;if(void 0===c)d(a);else{var g=JSON.stringify(c);Object.assign(c,a);var f=JSON.stringify(c);g!==f&&(console.debug("Update "+g),e.put(c))}};b.onerror=function(b){d(a)}});b.onabort=function(a){console.error(a)}})};
...
Wetplot.prototype._redraw_x_axis=function(){var a=createSvgElement("g");a.setAttribute("id","xAxisGroup");this._svgElement.appendChild(a);for(var c=createSvgElement("path"),b="",d=this._config.seconds_per_grid_line,e=this._config.time_offset,g=this._config.font_size_px,f=Math.round(e/d)*d; f<e+this._config.time_length; f+=d){var h=new Date(1E3*f),l=Math.round(this._seconds_to_x_coords(f));h=h.toLocaleDateString()+" "+h.toLocaleTimeString();h=h.substring(0,h.lastIndexOf(":"));var k=createSvgElement("text");
...
Wetplot.prototype.lineConfig=function(a,c,b){void 0!==b&&(this._line_config[a][c]=b);return this._line_config[a][c]};Wetplot.prototype.addWetplotData=function(a){this._addDataToDb("10min",a);this._data=null===this._data?a:WetplotData.concatenate(this._data,a)};Wetplot.prototype.usePalette=function(a){a=COLOR_PALETTES[a];var c=this.getAllLineCodes();if(a)for(var b=0;b<c.length;b++)this.lineConfig(c[b],"color",a[b%a.length])};
Wetplot.prototype._moveViewBoxPixels=function(a,c){a=void 0===a?0:a;c=void 0===c?!1:c;if(a){var b=$jscomp.makeIterator(this._svgElement.getAttribute("viewBox").split(" ")),d=b.next().value,e=b.next().value,g=b.next().value;b=b.next().value;d=c?a:Number.parseInt(d)+a;this._config.allow_scrolling_to_far||(d=Math.max(0,d),a=this._getXmax()-this._config.width,d=Math.min(d,a));e=[d,e,g,b].join(" ");this._x_offset=d;this._svgElement.setAttribute("viewBox",e)}};
...
Wetplot.prototype._seconds_to_values=function(a){var c=this,b=$jscomp.makeIterator(this._nearestTwoDataRows(a)),d=b.next().value,e=b.next().value,g={};b=this._data.heads.indexOf("Time");var f=d[b],h=(a-f)/(e[b]-f);this.getAllLineCodes().forEach(function(a){var b=c._data.heads.indexOf(a),f=d[b];g[a]=f+(e[b]-f)*h});return g};Wetplot.prototype.scrollTo=function(a){this._moveViewBoxPixels(a,!0)};var WetplotData=function(a,c){a=void 0===a?[]:a;c=void 0===c?[]:c;this.heads=a;this.values=c};
WetplotData.prototype.getValue=function(a,c){return(a=this.values[a])?a[this.getColumnIndex(c)]:void 0};WetplotData.prototype.getColumnIndex=function(a){return this.heads.indexOf(a)};
WetplotData.concatenate=function(a,c){var b=new WetplotData;a.heads.forEach(b.heads.push);c.heads.forEach(function(a){-1===b.heads.indexOf(a)&&b.push(a)});var d=a.getValue(0,"Time"),e=c.getValue(0,"Time"),g=Math.min(d,e);e=d=0;var f={},h={};for(b.heads.forEach(function(b){f[b]=a.getColumnIndex(b);h[b]=c.getColumnIndex(b)});d<a.values.length||e<c.values.length;){var l=a.getValue(d,"Time")-g,k=c.getValue(e,"Time")-g;if(isNaN(k)||l<=k){var m=[],n=a.values[d],p=$jscomp.makeIterator(b.heads);for(g=p.next();!g.done;g=
p.next())m.push(n[f[g.value]]);b.values.push(m);g=a.getValue(d,"Time");d++}if(isNaN(l)||k<=l){l=[];k=c.values[e];m=$jscomp.makeIterator(b.heads);for(g=m.next();!g.done;g=m.next())l.push(k[h[g.value]]);b.values.push(l);g=c.getValue(e,"Time");e++}}return b};WetplotData._add_columns=function(a,c,b){b=void 0===b?null:b;var d=c.length;if(!(0>=d)){for(var e=a.values.length,g=0;g<e;g++)for(var f=0;f<d;f++)a.values[g].push(b);c.forEach(function(b){return a.heads.push(b)})}};
WetplotData.prototype.forEachObject=function(a){var c=this,b={};this.values.forEach(function(d){for(var e=0;e<c.heads.length;e++)b[c.heads[e]]=d[e];a(Object.assign({},b))})};
